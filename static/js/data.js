...
const TEMPLATES = {
    ...
    enterprise: {
            ...
            layers: [
                { id: 1, name: 'Web Application', type: 'Frontend', status: 'Active', description: 'Customer-facing web app', technology: 'Next.js 14, TypeScript', responsibilities: 'Product browsing, checkout, user account', connections: [{ targetId: 3, type: 'HTTP' }], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 200, variableCost: 0, variableUnit: '', notes: 'CDN + hosting' }, substacks: [
                    { id: '1_1', name: 'Product Catalog UI', type: 'Frontend', status: 'Active', description: 'Product display components', technology: 'React Server Components', responsibilities: 'Product listings, search, filters', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '1_2', name: 'Shopping Cart', type: 'Frontend', status: 'Active', description: 'Cart management', technology: 'React Context', responsibilities: 'Add/remove items, calculate totals', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '1_3', name: 'Checkout Flow', type: 'Frontend', status: 'Active', description: 'Payment and shipping', technology: 'React Hook Form', responsibilities: 'Address, payment, order confirmation', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } }
                ]},
                { id: 2, name: 'Mobile App', type: 'Frontend', status: 'Active', description: 'iOS and Android apps', technology: 'React Native', responsibilities: 'Mobile shopping experience', connections: [{ targetId: 3, type: 'HTTP' }], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 150, variableCost: 0, variableUnit: '', notes: 'App store distribution' }, substacks: [
                    { id: '2_1', name: 'Native Modules', type: 'Frontend', status: 'Active', description: 'Platform-specific features', technology: 'Swift, Kotlin', responsibilities: 'Camera, push notifications, biometrics', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '2_2', name: 'Offline Mode', type: 'Frontend', status: 'Active', description: 'Offline functionality', technology: 'AsyncStorage, SQLite', responsibilities: 'Cache products, sync cart', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } }
                ]},
                { id: 3, name: 'API Gateway', type: 'API', status: 'Active', description: 'Unified API entry point', technology: 'Kong Gateway', responsibilities: 'Authentication, rate limiting, routing', connections: [{ targetId: 4, type: 'gRPC' }, { targetId: 5, type: 'HTTP' }, { targetId: 6, type: 'HTTP' }, { targetId: 7, type: 'HTTP' }, { targetId: 8, type: 'HTTP' }], dependencies: [1, 2], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 800, variableCost: 0.00001, variableUnit: 'per 1M requests', notes: 'Gateway infrastructure' }, substacks: [
                    { id: '3_1', name: 'Auth Middleware', type: 'API', status: 'Active', description: 'JWT validation', technology: 'Kong JWT Plugin', responsibilities: 'Verify tokens, extract user claims', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '3_2', name: 'Rate Limiter', type: 'API', status: 'Active', description: 'Request throttling', technology: 'Kong Rate Limiting', responsibilities: 'Prevent abuse, enforce quotas', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '3_3', name: 'Request Logger', type: 'API', status: 'Active', description: 'Audit logging', technology: 'Kong File Log', responsibilities: 'Log all API requests', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } }
                ]},
                { id: 4, name: 'Product Service', type: 'Backend', status: 'Active', description: 'Product catalog management', technology: 'Go, gRPC', responsibilities: 'Product CRUD, search, inventory', connections: [{ targetId: 9, type: 'Database' }, { targetId: 11, type: 'Event' }], dependencies: [3], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 600, variableCost: 0, variableUnit: '', notes: 'Microservice compute' }, substacks: [
                    { id: '4_1', name: 'Search Engine', type: 'Backend', status: 'Active', description: 'Full-text search', technology: 'Elasticsearch', responsibilities: 'Index products, fuzzy search', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '4_2', name: 'Image Processor', type: 'Backend', status: 'Active', description: 'Image optimization', technology: 'Sharp, ImageMagick', responsibilities: 'Resize, compress, generate thumbnails', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '4_3', name: 'Inventory Tracker', type: 'Backend', status: 'Active', description: 'Stock management', technology: 'Redis', responsibilities: 'Real-time stock levels', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } }
                ]},
                { id: 5, name: 'Order Service', type: 'Backend', status: 'Active', description: 'Order processing', technology: 'Java Spring Boot', responsibilities: 'Order creation, status tracking', connections: [{ targetId: 6, type: 'Async' }, { targetId: 10, type: 'Database' }, { targetId: 11, type: 'Event' }], dependencies: [3], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 700, variableCost: 0, variableUnit: '', notes: 'Microservice compute' }, substacks: [
                    { id: '5_1', name: 'Order Validator', type: 'Backend', status: 'Active', description: 'Validation logic', technology: 'Spring Validation', responsibilities: 'Validate order data, check inventory', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '5_2', name: 'Order State Machine', type: 'Backend', status: 'Active', description: 'Order workflow', technology: 'Spring State Machine', responsibilities: 'Manage order lifecycle', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '5_3', name: 'Notification Publisher', type: 'Backend', status: 'Active', description: 'Event publishing', technology: 'Kafka Producer', responsibilities: 'Publish order events', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } }
                ]},
                { id: 6, name: 'Payment Service', type: 'Backend', status: 'Active', description: 'Payment processing', technology: 'Python FastAPI', responsibilities: 'Process payments, refunds', connections: [{ targetId: 10, type: 'Database' }, { targetId: 11, type: 'Event' }], dependencies: [3, 5], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 500, variableCost: 0, variableUnit: '', notes: 'Microservice compute' }, substacks: [
                ...
                { id: 7, name: 'User Service', type: 'Backend', status: 'Active', description: 'User management', technology: 'Node.js Express', responsibilities: 'User accounts, authentication', connections: [{ targetId: 10, type: 'Database' }], dependencies: [3], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 400, variableCost: 0, variableUnit: '', notes: 'Microservice compute' }, substacks: [
                    { id: '7_1', name: 'Auth Handler', type: 'Backend', status: 'Active', description: 'Login/signup', technology: 'Passport.js', responsibilities: 'Email/password, OAuth', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '7_2', name: 'Profile Manager', type: 'Backend', status: 'Active', description: 'User profiles', technology: 'Express', responsibilities: 'Update profile, preferences', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '7_3', name: 'Session Store', type: 'Backend', status: 'Active', description: 'Session management', technology: 'Redis', responsibilities: 'Store active sessions', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } }
                ]},
                { id: 8, name: 'Notification Service', type: 'Backend', status: 'Active', description: 'Multi-channel notifications', technology: 'Node.js', responsibilities: 'Email, SMS, push notifications', connections: [{ targetId: 11, type: 'Message' }], dependencies: [3], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 300, variableCost: 0, variableUnit: '', notes: 'Microservice compute' }, substacks: [
                    { id: '8_1', name: 'Email Sender', type: 'Backend', status: 'Active', description: 'Email delivery', technology: 'SendGrid', responsibilities: 'Transactional emails', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '8_2', name: 'SMS Sender', type: 'Backend', status: 'Active', description: 'SMS delivery', technology: 'Twilio', responsibilities: 'Order updates via SMS', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '8_3', name: 'Push Sender', type: 'Backend', status: 'Active', description: 'Push notifications', technology: 'Firebase Cloud Messaging', responsibilities: 'Mobile push notifications', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } }
                ]},
                ...
                { id: 11, name: 'Message Queue', type: 'DevOps', status: 'Active', description: 'Event streaming', technology: 'Apache Kafka', responsibilities: 'Async communication between services', connections: [], dependencies: [4, 5, 6, 8], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 600, variableCost: 0, variableUnit: '', notes: 'Kafka cluster' }, substacks: [
                    { id: '11_1', name: 'Order Events Topic', type: 'DevOps', status: 'Active', description: 'Order event stream', technology: 'Kafka Topic', responsibilities: 'Order created, updated, shipped', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '11_2', name: 'Payment Events Topic', type: 'DevOps', status: 'Active', description: 'Payment event stream', technology: 'Kafka Topic', responsibilities: 'Payment success, failure, refund', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '11_3', name: 'Notification Queue', type: 'DevOps', status: 'Active', description: 'Notification queue', technology: 'Kafka Topic', responsibilities: 'Queue notifications for delivery', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } }
                ]},
                { id: 12, name: 'Infrastructure', type: 'DevOps', status: 'Active', description: 'Cloud infrastructure', technology: 'AWS, Terraform', responsibilities: 'Provision and manage cloud resources', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 1000, variableCost: 0, variableUnit: '', notes: 'Infrastructure overhead' }, substacks: [
                    { id: '12_1', name: 'Container Orchestration', type: 'DevOps', status: 'Active', description: 'Kubernetes cluster', technology: 'AWS EKS', responsibilities: 'Deploy and scale containers', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '12_2', name: 'Load Balancer', type: 'DevOps', status: 'Active', description: 'Traffic distribution', technology: 'AWS ALB', responsibilities: 'Distribute traffic, SSL termination', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '12_3', name: 'Monitoring', type: 'DevOps', status: 'Active', description: 'Observability stack', technology: 'Prometheus, Grafana', responsibilities: 'Metrics, logs, alerts', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } },
                    { id: '12_4', name: 'CI/CD Pipeline', type: 'DevOps', status: 'Active', description: 'Automated deployment', technology: 'GitHub Actions', responsibilities: 'Build, test, deploy', connections: [], dependencies: [], visible: true, locked: false, costModel: { currency: 'USD', period: 'month', fixedCost: 0, variableCost: 0, variableUnit: '', notes: '' } }
                ]}
            ]
        }};
